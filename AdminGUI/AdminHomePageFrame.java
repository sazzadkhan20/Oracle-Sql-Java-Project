...
public class AdminHomePageFrame extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			this.dispose();
			PassengerDetails passengerDetails = new PassengerDetails(this,login);
		}
		if(e.getSource()==button3)
		{
			this.dispose();
			UpdateIntercityTrainInfoFrame updateIntercityTrainInfo = new UpdateIntercityTrainInfoFrame(this,login);
		}
	}
