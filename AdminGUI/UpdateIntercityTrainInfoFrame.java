...
public class UpdateIntercityTrainInfoFrame extends JFrame implements ActionListener
{
	...
	public UpdateIntercityTrainInfoFrame(AdminHomePageFrame adminhome,LogInFrame login)
	{
	...
	public void initializeForm()
	{
		...
		button13=new JButton("More Info");
		button13.setBounds(580,80,103,40);
		...
		button7=new JButton("Update Train Info");
		...
		button11=new JButton("Remove Route");
	...
	public void createTable()
	{
		...
		model.addColumn("Ticket Price(Tk)");
		...
		try {
            ...
            ResultSet rs = stmt.executeQuery("select tr.t_id,t.t_name,tr.r_id,r.r_info,amt.price from train_info t,route_info r,tr_info tr,admin_manage_ticket amt where t.t_id=tr.t_id and r.r_id=tr.r_id and tr.r_id=amt.r_no order by t_id");
            while (rs.next()){
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==button5)
		{
			...
			AddStation addstation = new AddStation(this,login,adminhome);
		}
		if(e.getSource()==button6)
		{
			this.setVisible(false);
			AddNewTrain addingNewTrain = new AddNewTrain(this,login,adminhome);
		...
		{
			this.setVisible(false);
			UpdateTicketPrice updatingTicketPrice = new UpdateTicketPrice(this,login,adminhome);
		}
		...
		{
			this.setVisible(false);
			RemoveTrain  removeTrain = new RemoveTrain(this,login,adminhome);
		}
		
		if(e.getSource()==button13)
		{
			this.setVisible(false);
			traininfo  Traininfo = new traininfo(this,login,adminhome);
		}
